...
public class UIComponents {
    ...
    private static final int STATUS_BAR_COLOR = R.color.colorPrimary;
    ...
    @BindView(R.id.ivEndIcon)
    ImageView ivEndIcon;
    @BindView(R.id.ivEndIcon2)
    ImageView ivEndIcon2;
    @BindView(R.id.tvTitle)
    TextView tvTitle;
    @BindView(R.id.tvEndAction)
